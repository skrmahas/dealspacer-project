  ...
  return (
    <>
      ...
      >
        <div
          className={cn(
            "mx-auto flex w-full box-border items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:px-10",
            maxWidthClass,
          )}
        >
      ...
      {menuOpen && (
        <>
          <button
            type="button"
            className="fixed inset-0 z-30 bg-[#040608]/75 backdrop-blur-sm md:hidden"
          ...
          <div
            id={menuId}
            className={cn(
              "fixed inset-x-0 top-[61px] z-50 border-b border-[#2b79db]/[0.15] bg-[#0a0e14]/[0.98] px-4 py-4 backdrop-blur-md md:hidden",
              "max-h-[min(70vh,calc(100dvh-61px))] overflow-y-auto",
            )}
          >
