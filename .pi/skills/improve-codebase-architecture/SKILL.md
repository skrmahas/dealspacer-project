...
Use these terms exactly in every suggestion. Consistent language is the point — don't drift into "component," "service," "API," or "boundary." Full definitions in the Language Reference section below.
...
**Use CONTEXT.md vocabulary for the domain, and the Language Reference vocabulary for the architecture.**
...
- **Want to flesh out the design further?** Drop into a `/skill:grill-me` session.
- **Want to explore alternative interfaces for the deepened module?** Use the Interface Design process below.
...
- The dependencies it would rely on, and which dependency category they fall into (see Dependency Categories below)
...
Include the Language Reference vocabulary and CONTEXT.md vocabulary in the brief so each sub-agent names things consistently.
